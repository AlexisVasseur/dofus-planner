      ...
      >
        ...
        <div class="px-5 py-4 flex flex-col gap-3">
          ...
          <textarea
            ...
            spellcheck="false"
            autocomplete="off"
            placeholder='Coller le code ici. ex : "hqEwi6EwzQOEoTFkoTJkoTNkoTRkoTVkoTYHoTcDoTlkojExAaIyM80D6KExlgDM8EsAAAChMsygoTMfoTSJoTUCoTYGojEwAKIxMQCiMTIAojEzAKIxNACiMTUAojE2AKE13AAQzVxCzSKQzSKezVxDzSKfzTa4zS1mzR5KzQK2zTW/zTYEzQPMzTQgzVxFzSKFzYIG"'
